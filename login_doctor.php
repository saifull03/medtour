...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and execute SQL query to check doctor credentials
...
<head>
    ...
    <title>Doctor Login Portal</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <div class="signup-link">
            <a href="signup_doctor.php">Don't have an account? Sign up here.</a>
        </div>
    </div>
</body>
</html>
